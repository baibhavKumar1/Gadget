...
const Sidebar = () => {
  ...
  return (
    <div className='bg-gray-500 w-1/5 rounded-xl mt-4 m-3 flex flex-col  justify-start' style={{ height: "84vh" }}>
      ...
      {isAdmin && <button className='w-2/3 hover:bg-white mx-auto m-3 text-xl p-3 rounded-xl'><NavLink to="/admin/logout" className='flex items-center gap-2'><FaArrowRightFromBracket /><p>Users</p></NavLink></button>}
